...
const AdminServiceForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEdit) {
        await axios.put(`${process.env.REACT_APP_BACKEND_URL}/api/services/${id}`, data, { headers });
        toast.success('Service updated successfully');
      } else {
        await axios.post(`${process.env.REACT_APP_BACKEND_URL}/api/services`, data, { headers });
